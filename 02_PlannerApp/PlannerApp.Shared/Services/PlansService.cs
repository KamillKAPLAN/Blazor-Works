...
namespace PlannerApp.Shared.Services
{
    public class PlansService
    {
        ...
        {
            var response = await serviceClient.GetProtectedAsync<PlanSingleResponse>($"{_baseUrl}/api/Plans/{id}");
            return response.Result;
        }
        ...
        public async Task<PlanSingleResponse> PostPlanAsync(PlanRequest model)
        {
            ...
            var response = await serviceClient.SendFormProtectedAsync<PlanSingleResponse>($"{_baseUrl}/api/plans", ActionType.POST, formKeyValues.ToArray());
            return response.Result;
        }
        ...
        /// <param name="model">object represents the plan to be added</param>
        /// <returns></returns>
        public async Task<PlanSingleResponse> PutPlanAsync(PlanRequest model)
        {
            var formKeyValues = new List<FormKeyValue>()
            {
            ...
            var response = await serviceClient.SendFormProtectedAsync<PlanSingleResponse>($"{_baseUrl}/api/plans", ActionType.PUT, formKeyValues.ToArray());
